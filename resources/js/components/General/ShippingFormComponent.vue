    ...
    <div>
        ...
        >
            ...
            <div id="AddAddress" class="form-vertical">
                <h2>{{editAddress ? 'Adit Address' : 'Add a New Address' }}</h2>
                ...
                <div class="grid">
                    ...
                    <div class="grid__item large--one-half">
                        ...
                        >
                            ...
                            <option value="El Salvador" data-provinces="[]">
                                El Salvador
                            </option>
                            <option
                            ...
                            <option
                                value="New Zealand"
                                data-provinces='[["Auckland","Auckland"],["Bay of Plenty","Bay of Plenty"],["Canterbury","Canterbury"],["Chatham Islands","Chatham Islands"],["Gisborne","Gisborne"],["Hawke&apos;s Bay","Hawke’s Bay"],["Manawatu-Wanganui","Manawatu-Wanganui"],["Marlborough","Marlborough"],["Nelson","Nelson"],["Northland","Northland"],["Otago","Otago"],["Southland","Southland"],["Taranaki","Taranaki"],["Tasman","Tasman"],["Waikato","Waikato"],["Wellington","Wellington"],["West Coast","West Coast"]]'
                            >
                                New Zealand
                            </option>
                ...
                <p>
                    <a href="#" @click="editAddress ? cancelEdit() : toggleNewForm()">Cancel</a>
                </p>
...
<script>
    export default {
        ...
        props: ['editAddress', 'toggleNewForm'],
        methods: {
            cancelEdit() {
